 ...
 *  @author Kevin Wayne
 */
public class Week1Exc1WeightedQuickUnion {
     ...
     */
    public Week1Exc1WeightedQuickUnion(int N) {
        count = N;
        id = new int[N];
        sz = new int[N];
        for (int i = 0; i < N; i++) {
    ...
    /**
     * Prints each element and his index in order to display
     * and understand the algorithm behaviour visually
     */
    public void printElementsAndIndexes(){
    ...
    public static void main(String[] args) {
        int N = StdIn.readInt();
        Week1Exc1WeightedQuickUnion uf = new Week1Exc1WeightedQuickUnion(N);
        while (!StdIn.isEmpty()) {
            int p = StdIn.readInt();
            int q = StdIn.readInt();
